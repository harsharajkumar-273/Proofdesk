...
export interface BuildFailurePayload extends DiagnosticAdvice {
  error: string;
  details: string;
}

const summarizeBuildFailure = (message = ''): DiagnosticAdvice => {
...
export const buildFailurePayload = (message = '', details = ''): BuildFailurePayload => ({
